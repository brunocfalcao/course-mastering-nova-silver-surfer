<div
    ...
    <div class="flex flex-col w-full md:w-1/2 px-2">
        <div
            class="max-w-full md:max-w-[76%] lg:max-w-[82%] xl:max-w-full font-medium text-4xl xl:text-5xl px-4 md:px-0">
            Medium, rare, but mostly well-done HTML email components.
        </div>

        <div
            class="progress-area flex flex-col justify-center md:flex-row space-y-8 md:space-y-0 space-x-0 px-4 md:px-0 md:space-x-4 lg:space-x-4 xl:space-x-8 mt-3 lg:mt-4 xl:mt-8">
