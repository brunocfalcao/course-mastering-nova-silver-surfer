            ...
            <tbody>
                <tr>
                    ...
                    <td align="center" bgcolor="#FFFFFF">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td align="center" class="center-text">
                                                        <a href="{{ eduka_url($subscriber->course->domain) }}" target="_blank"><img style="width:100px;border:0px;display:inline!important;" src="{{  eduka_url($subscriber->course->domain, Storage::disk('public')->url($subscriber->course->filename_email_logo)) }}" width="100" border="0" alt="{{ $subscriber->course->name }}"></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                ...
                                <tr>
                                    <td align="center" bgcolor="#FFFFFF" class="container-padding">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                            <tbody>
                                                <tr style="">
                                                    <td class="center-text" align="center" style="font-family:'Barlow', Arial, Helvetica, sans-serif;font-size:24px;line-height:48px;font-weight:700;font-style:normal;color:{{ $subscriber->course->theme_color }};text-decoration:none;letter-spacing:0px;">
                                                        <div style="margin: 0px; padding: 0px;">
                                                            <p style="margin: 0px; padding: 0px;">GET READY TO LAUNCH!<br></p>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr style="">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="rwd-col" align="center" valign="top" width="79.53" style="width:79.53%;max-width:79.53%;">
                                                                        ...
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="100%" style="width:100%;max-width:100%;">
                                                                            <tbody>
                                                                                <tr style="">
                                                                                    <td class="center-text" align="left" style="font-family:'Roboto', Arial, Helvetica, sans-serif;font-size:18px;line-height:28px;font-weight:400;font-style:normal;color:rgb(51, 51, 51);text-decoration:none;letter-spacing:0px;">
                                                                                        <div style="margin: 0px; padding: 0px;">
                                                                                            <p style="margin: 0px; padding: 0px;">Hello Astronaut!</p>
                                                                                            <br>
                                                                                            <p style="margin: 0px; padding: 0px;">Thank you for signing up for the new Mastering Nova course!</p>
                                                                                            <p style="margin: 0px; padding: 0px;"><br></p>
                                                                                            <p style="margin: 0px; padding: 0px;">Just like preparing for a space mission, we're about to embark on an exciting journey to explore the depths of Laravel Nova.</p>
                                                                                            <p style="margin: 0px; padding: 0px;"><br></p>
                                                                                            <p style="margin: 0px; padding: 0px;">I'm thrilled to guide you through this adventure and to offer you an exclusive discount for our launch day.</p>
                                                                                            <br>
                                                                                            <p style="margin: 0px; padding: 0px;">Stay tuned for our countdown to lift-off!</p>
                                                                                            <br>
                                                                                            <p style="margin: 0px; padding: 0px;">Clear skies and good coding,</p>
                                                                                            <p style="margin: 0px; padding: 0px;">Bruno Falcão</p>
                                                                                        </div>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                        ...
                        <table data-outer-table="" border="0" align="center" cellpadding="0" cellspacing="0" class="outer-table row container-padding" role="presentation" width="800" style="width:800px;max-width:800px;">
                            <!-- blue-send-email -->
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    <td class="center-text" align="center" style="font-family:'Barlow', Arial, Helvetica, sans-serif;font-size:20px;line-height:26px;font-weight:400;font-style:normal;color:rgb(110, 110, 110);text-decoration:none;letter-spacing:0px;">
                                        <div style="margin: 0px; padding: 0px;">
                                            <p xmlns="http://www.w3.org/1999/xhtml" style="margin: 0px; padding: 0px;"><u><a href="https://www.masteringnova.com" target="_blank" style="text-decoration: none;">www.masteringnova.com</a></u></p>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
