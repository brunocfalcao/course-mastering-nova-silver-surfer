                                                                    ...
                                                                    <td class="rwd-col" align="center" valign="top" width="15%" style="width:15%;max-width:15%">
                                                                        ...
                                                                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center">
                                                                                        <img class="auto-width" style="display:block;width:100%;max-width:140px;border:6px solid {{ $subscriber->course->theme_color }};border-radius:100%;" width="108" src="{{ Storage::url($subscriber->course->filename_twitter) }}" border="0" alt="picture">
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
